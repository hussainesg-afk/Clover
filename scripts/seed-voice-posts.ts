...
const VOICE_POSTS = [
  ...
  { body: "Who wants to play tennis today? Looking for anyone near Southville who fancies a hit.", category: "events", postCode: "BS3 1BN", socialLevel: "moderate", preferredTime: "Weekend mornings", groupSize: "1-5" },
  ...
  { body: "Anyone want to start a 5-a-side football group? Wednesday evenings ideally.", category: "events", postCode: "BS3 1RB", socialLevel: "high", preferredTime: "Weekday evenings", groupSize: "10-20" },
  ...
  { body: "Would love a beginner running club. Couch to 5K style, no pressure, Ashton Court maybe?", category: "events", postCode: "BS3 2HG", socialLevel: "moderate", preferredTime: "Weekend mornings", groupSize: "10-20" },
  { body: "Anyone want to play padel? Just picked it up and looking for regular partners.", category: "events", postCode: "BS3 1AB", socialLevel: "moderate", preferredTime: "Weekend afternoons", groupSize: "1-5" },
  ...
  { body: "Any interest in a Saturday morning swim club? Hengrove pool, nice and casual.", category: "events", postCode: "BS14 0DE", socialLevel: "moderate", preferredTime: "Weekend mornings", groupSize: "10-20" },
